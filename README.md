...
MVP de Historia Clínica Digital Interoperable
Objetivo General
...
Semana 1 – Fundamentos y Base Técnica
...
Semana 2 – Permisos, Token y Demostración
...
Contrato eERC-20 desplegado en la Testnet L1 de Avalanche (Higia) para SaluData.

Contrato de Registros Médicos y Permisos en Solidity, funcional y desplegado.

Web DApp (Prueba de Concepto):
